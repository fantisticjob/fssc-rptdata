...
import com.longfor.fsscreportdb.ods.mapper.OdsZdSwglzzsfb1Mapper;
...
public class OdsZdSwglzzsfb1ServiceImpl extends ServiceImpl<OdsZdSwglzzsfb1Mapper, OdsZdSwglzzsfb1> implements IOdsZdSwglzzsfb1Service {
		...
		try {
			do {
				...
				if(token.get(CommonConstant.ACCESSTOKEN)!=null 
					...
					buffer.append(properties.getProperties("swglzzsfb1"));
				...
				if("200".equals(String.valueOf(datas.get("resultcode")))) {
					List<OdsZdSwglzzsfb1> list = StringToDate( datas.get("records"));
	...
	public List<OdsZdSwglzzsfb1>  StringToDate(Object object) {
		JSONArray array = JSONArray.parseArray( object.toString());
		ArrayList<OdsZdSwglzzsfb1> list = new ArrayList<>();
		for (int i = 0; i < array.size(); i++) {
			Object o = array.get(i);
			OdsZdSwglzzsfb1 parseObject = JSON.parseObject(o.toString(),OdsZdSwglzzsfb1.class);
