 ...
 */
@Service
public class OdsSkjGetskjServiceImpl extends ServiceImpl<OdsSkjGetskjMapper, OdsSkjGetskj> implements IOdsSkjGetskjService {
	
    private final Logger log = LoggerFactory.getLogger(OdsSkjGetskjServiceImpl.class);
...
//			String sql  = "delete from ODS_SKJ_GETSKJ";
//			dao.delete(sql);
			...
			String sql  = "select count(1)  from ODS_SKJ_GETSKJ";
	...
	public List<OdsSkjGetskj>  StringToDate(Object object) {
		...
		for (int i = 0; i < array.size(); i++) {
			...
			if(!"作废".equals(parseObject.getStatus()) && !"核销单".equals(parseObject.getVouchtype())) {
