...
import com.longfor.fsscreportdb.ods.mapper.OdsZdSwglzzsfb4Mapper;
...
public class OdsZdSwglzzsfb4ServiceImpl extends ServiceImpl<OdsZdSwglzzsfb4Mapper, OdsZdSwglzzsfb4> implements IOdsZdSwglzzsfb4Service {
		...
		try {
			do {
				...
				if(token.get(CommonConstant.ACCESSTOKEN)!=null 
					...
					buffer.append(properties.getProperties("swglzzsfb4"));
				...
				if("200".equals(String.valueOf(datas.get("resultcode")))) {
					List<OdsZdSwglzzsfb4> list = StringToDate( datas.get("records"));
	...
	public List<OdsZdSwglzzsfb4>  StringToDate(Object object) {
		JSONArray array = JSONArray.parseArray( object.toString());
		ArrayList<OdsZdSwglzzsfb4> list = new ArrayList<OdsZdSwglzzsfb4>();
		for (int i = 0; i < array.size(); i++) {
			Object o = array.get(i);
			OdsZdSwglzzsfb4 parseObject = JSON.parseObject(o.toString(),OdsZdSwglzzsfb4.class);
