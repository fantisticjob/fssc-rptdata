...
import com.longfor.fsscreportdb.ods.mapper.OdsZdSwglzzsfb2Mapper;
...
public class OdsZdSwglzzsfb2ServiceImpl extends ServiceImpl<OdsZdSwglzzsfb2Mapper, OdsZdSwglzzsfb2> implements IOdsZdSwglzzsfb2Service {
		...
		try {
			do {
				...
				if(token.get(CommonConstant.ACCESSTOKEN)!=null 
					...
					buffer.append(properties.getProperties("swglzzsfb2"));
				...
				if("200".equals(String.valueOf(datas.get("resultcode")))) {
					List<OdsZdSwglzzsfb2> list = StringToDate( datas.get("records"));
	...
	public List<OdsZdSwglzzsfb2>  StringToDate(Object object) {
		JSONArray array = JSONArray.parseArray( object.toString());
		ArrayList<OdsZdSwglzzsfb2> list = new ArrayList<>();
		for (int i = 0; i < array.size(); i++) {
			Object o = array.get(i);
			OdsZdSwglzzsfb2 parseObject = JSON.parseObject(o.toString(),OdsZdSwglzzsfb2.class);
