...
public class MyTestController {
    ...
    public static final String longforChatSitKey = "4bde8669-c6e1-47e6-ba5c-7ac37182c2d6";  //测试
    public static final String longforChatSitUrl = "http://api.longfor.sit/longchat-open-api-sit"; //测试
    ...
    public void executeFunc(String s){
        debugFlag = s;
        try {
            sendMsgByGroup();
        } catch (Exception e){
    ...
    public void processClearRecordForGroup(List<OdsHrDirct> odsHrDircts) {
        ...
        for (OdsHrDirct os: odsHrDircts) {
            if (org.apache.commons.lang.StringUtils.isNotBlank(os.getAreaName()) && "集团".equals(os.getAreaName())) {
                //忽略地区是集团的记录
                continue;
            }
            if(org.apache.commons.lang.StringUtils.isNotBlank(os.getChannelNm())) {
                switch (os.getChannelNm()) {
                    ...
                    case "C4":
                        ...
                        if (org.apache.commons.lang.StringUtils.isNotBlank(os.getRegionName()) && os.getRegionName().contains("大区")) {
                            updListC4.add(os);
                        }
                        break;
                    case "C5":
    ...
    public void alertGroupForSecondTime(List<OdsHrDirct> dccud) {
        ...
        for (int i = 0; i < dccud.size(); i++) {
            ...
            //处理第一条记录
            if (org.apache.commons.lang.StringUtils.isBlank(lastGroupId)) {
    ...
    private void getLastRegionGroupList(List<OdsHrDirct> dccud, String channalNm) {
        ...
        for (int i = 0; i < dccud.size(); i++) {
            ...
            //处理第一条记录
            if (org.apache.commons.lang.StringUtils.isBlank(lastRegionId)) {
                ...
                if(!userList.contains(responsUser)){
                    ...
                    if (org.apache.commons.lang.StringUtils.isNotBlank(userDirct)){
    ...
    private void getLastAreaGroupList(List<OdsHrDirct> dccud, String channalNm) {
        ...
        for (int i = 0; i < dccud.size(); i++) {
            ...
            //处理第一条记录
            if (org.apache.commons.lang.StringUtils.isBlank(lastArea)) {
                lastArea = currArea;
                responsUser = updRecord.getOaccount();
                if(!userList.contains(responsUser)){
                    userList.add(responsUser);
    ...
    private List<OdsDepartmetClear> prcessDeptmentList(List<OdsHrDirct> areaRecordList) {
        ...
        for (OdsHrDirct updRecord : areaRecordList) {
            ...
            if (org.apache.commons.lang.StringUtils.isBlank(lasDept)) {
                lasDept = currDept;
                deptNumber++;
...
/*          userList.add("w_zhaobo14");
            ...
            Result createGroupResult = OpenApiClient.createGroup(createGroupDTO,
                    "http://api.longfor.sit/longchat-open-api-sit/createGroup",
                    "4bde8669-c6e1-47e6-ba5c-7ac37182c2d6", null);
    ...
    public JSONObject getManagersByRoleAndArea(String areaName, String lineCode, boolean isRegion) {
        ...
        if (isRegion) {
            ...
            if (org.apache.commons.lang.StringUtils.isNotBlank((areaName))) {
                areaCode = areaMapping.get(areaName);
            }
            if (org.apache.commons.lang.StringUtils.isBlank(areaCode)) {
        ...
        //判断返回结果
        if (json != null && org.apache.commons.lang.StringUtils.isNotBlank(json.getString("respCode"))) {
            //
            JSONObject respCode = JSONObject.parseObject(json.getString("respCode"));
            if (respCode != null && org.apache.commons.lang.StringUtils.isNotBlank(respCode.getString("code")) && "1".equals(respCode.getString("code"))) {
                ...
                try {
                    ...
                    if (org.apache.commons.lang.StringUtils.isNotBlank(whiteUsrStr)) {
                ...
                for (Object userObj : data) {
                    ...
                    if (org.apache.commons.lang.StringUtils.isNotBlank(lineFromAm) && lineFromAm.equals(lineCode)) {
                        //C4航道，只需要获取大区财务部的负责人(orgType=06)
                        if ("C4".equals(lineCode)) {
                            String orgType = jsonObject.getString("orgTypeCode");
                            if (org.apache.commons.lang.StringUtils.isNotBlank(orgType) && "06".equals(orgType)) {
                                String userName = jsonObject.getString("userName");
                                if (org.apache.commons.lang.StringUtils.isNotBlank(userName) && !managerList.contains(userName)) {
