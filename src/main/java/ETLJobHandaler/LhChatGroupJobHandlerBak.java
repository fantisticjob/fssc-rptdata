 ...
 * @date 2021/6/30
 */
@JobHandler(value = "LhChatGroupJobHandlerBak")
@Component
@Slf4j
public class LhChatGroupJobHandlerBak extends IJobHandler {

    private static final Logger log = LoggerFactory.getLogger(LhChatGroupJobHandlerBak.class);
    ...
    public void processClearRecordForGroup(List<OdsHrDirct> odsHrDircts) {
        if (odsHrDircts != null && 0 < odsHrDircts.size()) {
            return;
        }
        //保存不同航道的list
